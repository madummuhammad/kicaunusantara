                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('Laramagz::magz.all_videos') }}</li>
                        </ol>
                        <h1 class="page-title">{{ __('Laramagz::magz.all_videos') }}</h1>
                    </div>
                </div>
                <div class="line"></div>
                <div class="row">
                    ...
                    <article class="col-lg-12 article-list">
                        <div class="inner">
                            <figure>
                                <a href="{{ $videoHelper->getUriPost($post) }}" aria-label="{{ $post->post_title }}">
